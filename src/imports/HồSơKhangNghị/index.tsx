import svgPaths from "./svg-u26nafv5ts";
...
function HtmlBody() {
  return (
    <div className="content-stretch flex isolate items-start relative self-stretch shrink-0 w-[288px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 246) 0%, rgb(243, 244, 246) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="Html → Body">
      <Frame1 />
    </div>
  );
}
...
function Group3() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1076px] mt-[663px] place-items-start relative row-1">
      <div className="[word-break:break-word] col-1 flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center ml-0 mt-0 not-italic relative row-1 text-[10px] text-black w-[117.985px]">
        <p className="mb-0">
...
function Group4() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
      <div className="[word-break:break-word] col-1 flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center ml-0 mt-0 not-italic relative row-1 text-[10px] text-black w-[157px]">
        <p className="mb-0">
...
function Group5() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1072px] mt-[531px] place-items-start relative row-1">
      <Group4 />
      <div className="col-1 h-0 ml-[15px] mt-[38px] relative row-1 w-[117px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 117 1" width="117">
            <line id="Line 1" stroke="var(--stroke-0, #D1D5DB)" x2="117" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Group6() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
      <div className="[word-break:break-word] col-1 flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center ml-0 mt-0 not-italic relative row-1 text-[10px] text-black w-[136.755px]">
        <p className="mb-0">
          <span className="leading-[16px]">Ngày nhận:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 10/6/2026`}</span>
        </p>
...
function Group8() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1070px] mt-[503px] place-items-start relative row-1">
      <Group6 />
      <div className="col-1 h-0 ml-[1.39px] mt-[22px] relative row-1 w-[135.614px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 135.614 1" width="135.614">
            <line id="Line 1" stroke="var(--stroke-0, #D1D5DB)" x2="135.614" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Data2() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[300px]" data-name="Data">
...
function Data3() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[24px] pr-[12px] py-[39.5px] relative shrink-0 w-[200px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[170px] whitespace-pre-wrap">
        <p className="mb-0">
...
function Data4() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[260px]" data-name="Data">
      <Container83 />
      <Container84 />
      <Container85 />
    </div>
...
function BackgroundBorder1() {
  return (
    <div className="bg-white content-stretch flex items-end justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0" data-name="Background+Border">
...
function Container88() {
  return (
    <div className="content-stretch flex flex-col h-[29px] items-start relative shrink-0 w-[88px]" data-name="Container">
      <BackgroundBorder1 />
    </div>
  );
}
...
function Data5() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[12px] relative shrink-0 w-[230px]" data-name="Data">
      <Data6 />
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-col items-start pl-[24px] pr-[12px] py-[39.5px] relative shrink-0 w-[200px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">
        ...
        <p className="whitespace-pre">
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">{`Người kháng nghị: `}</span>
          <span className="leading-[16px]">TANDTC</span>
        </p>
      </div>
    </div>
  );
...
function BackgroundBorder4() {
  return (
    <div className="bg-[#fff7ed] content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0 w-[110px]" data-name="Background+Border">
...
function Data15() {
  return (
    <div className="col-1 content-stretch flex flex-col h-[24px] items-start ml-0 mt-[31.33px] pl-[24px] relative row-1 w-[65.546px]" data-name="Data">
      <BackgroundBorder4 />
    </div>
  );
}
...
function Button14() {
  return (
    <a className="bg-[#8b0000] col-1 content-stretch cursor-pointer flex flex-col h-[24px] items-center justify-center ml-[33.37px] mt-0 px-[8px] py-[4px] relative rounded-[4px] row-1 w-[73.862px]" data-name="Button">
...
function BackgroundBorder3() {
  return (
    <div className="bg-white content-stretch flex h-[87px] items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0 w-[230px]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[9999px]" />
      <Group />
    </div>
  );
...
function Data16() {
  return <div className="h-[111px] relative shrink-0 w-[182px]" data-name="Data" />;
}
...
function TableRow1() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 8">
      <Data10 />
      <Data11 />
      <Data12 />
      <Data13 />
...
function Container98() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Ngày văn thư đến:</span>
...
function TableRow2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Table Row 9">
      <Data18 />
      <Data19 />
      <Data20 />
      <Data21 />
...
function TlVAnChaCoVAn() {
  return (
    <div className="col-1 content-stretch flex h-[1038px] items-start ml-0 mt-0 relative row-1 w-[1380px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 246) 0%, rgb(243, 244, 246) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="TL vụ án- Đơn chờ phê duyệt">
      <Main />
    </div>
  );
}
...
function Group14() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1087px] mt-[522px] place-items-start relative row-1">
      <Group7 />
      <div className="col-1 h-0 ml-[15px] mt-[38px] relative row-1 w-[117px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 117 1" width="117">
...
function Group15() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1087px] mt-[672px] place-items-start relative row-1">
      <Group9 />
      <div className="col-1 h-0 ml-[15px] mt-[38px] relative row-1 w-[117px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 117 1" width="117">
...
function Group10() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1083px] mt-[799px] place-items-start relative row-1">
      <Group11 />
...
function Group12() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1086px] mt-[959px] place-items-start relative row-1">
      <Group13 />
      <div className="col-1 h-0 ml-[15px] mt-[22px] relative row-1 w-[117px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 117 1" width="117">
            <line id="Line 1" stroke="var(--stroke-0, #D1D5DB)" x2="117" y1="0.5" y2="0.5" />
          </svg>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col items-start relative self-stretch shrink-0 w-[1380px]">
      <Group17 />
    </div>
  );
}

export default function HSKhangNgh() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="Hồ sơ kháng nghị">
      <HtmlBody />
      <Frame2 />
    </div>
  );
